...
func TestRoundToMultiple(t *testing.T) {
	t.Run("ZeroMultiple", func(t *testing.T) {
		assert.Equal(t, uint16(6), RoundToMultiple(6, 0))
		assert.Equal(t, uint16(7), RoundToMultiple(7, 0))
		assert.Equal(t, uint16(8), RoundToMultiple(8, 0))
		assert.Equal(t, uint16(9), RoundToMultiple(9, 0))
	})
}
...
func TestFloorToMultiple(t *testing.T) {
	t.Run("ZeroMultiple", func(t *testing.T) {
		assert.Equal(t, uint16(6), FloorToMultiple(6, 0))
		assert.Equal(t, uint16(7), FloorToMultiple(7, 0))
		assert.Equal(t, uint16(8), FloorToMultiple(8, 0))
		assert.Equal(t, uint16(9), FloorToMultiple(9, 0))
	})
}
...
func TestCeilToMultiple(t *testing.T) {
	t.Run("ZeroMultiple", func(t *testing.T) {
		assert.Equal(t, uint16(6), CeilToMultiple(6, 0))
		assert.Equal(t, uint16(7), CeilToMultiple(7, 0))
		assert.Equal(t, uint16(8), CeilToMultiple(8, 0))
		assert.Equal(t, uint16(9), CeilToMultiple(9, 0))
	})
}
